...
if (False):
    print("Range with 1 argument goes from 0 through n-1")
    for num in range(10):
        print(num)

    print("Range with 2 arguments goes from the first number through the last-1")
    for num in range(7, 15):
        print(num)

    print("Range with 3 arguments goes from the first number through the")
    for num in range(2, 12, 2):
        print(num)

    print("Range with 3 arguments and a negative step")

...
6. Now define the function print guessed() that returns a string that contains the word with
...
comments within your code file, so you can use this as a guideline to write your code. Hint:
